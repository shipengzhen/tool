...
public class SysDepartmentDaoImpl extends HibernateDaoSupport implements SysDepartmentDao{
       private static final Log log = LogFactory.getLog(SysDepartmentDaoImpl.class);
       /**
    ...
    public void insert(SysDepartment vo) throws Exception{
        try {
    ...
    public void modify(SysDepartment vo) throws Exception{
        try {
    ...
    public void remove(SysDepartment vo) throws Exception{
        try {
		...
		List list = getHibernateTemplate().executeFind(new HibernateCallback() { 
			public Object doInHibernate(Session session) 
				...
				if(is){
				    ...
				    query = session.createSQLQuery(hql).addEntity(com.oa.dao.SysDepartment.class);
				}
	...
	public List query(SysDepartment vo)throws Exception{
	     ...
	     java.math.BigDecimal _Did = vo.getDid();
	     if(_Did != null && !_Did.equals("")){
	             ls_sql = ls_sql + " and DID='" + _Did + "'";
	     }
	     java.lang.String _Dname = vo.getDname();
	     if(_Dname != null && !_Dname.equals("")){
	             ls_sql = ls_sql + " and DNAME='" + _Dname + "'";
	     }

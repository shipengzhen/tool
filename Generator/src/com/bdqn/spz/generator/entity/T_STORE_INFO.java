...
public class T_STORE_INFO{
	...
	private String aUDITING_STATE;

	private String sTATUS;

	private String bUSSINESS_CIRCLE_ID;
	...
	private String lICENSENUMBERIMG;
	...
	public void setPOSI_X(String pOSI_X){
		this.pOSI_X=pOSI_X;
	}

	public String getPOSI_X(){
		return pOSI_X;
	}
	...
	public void setBUSSINESS_CIRCLE_ID(String bUSSINESS_CIRCLE_ID){
		this.bUSSINESS_CIRCLE_ID=bUSSINESS_CIRCLE_ID;
	}

	public String getBUSSINESS_CIRCLE_ID(){
		return bUSSINESS_CIRCLE_ID;
	}
	...
	public void setPOSI_Y(String pOSI_Y){
		this.pOSI_Y=pOSI_Y;
	}

	public String getPOSI_Y(){
		return pOSI_Y;
	}
	...
	public void setLICENSENUMBERIMG(String lICENSENUMBERIMG){
		this.lICENSENUMBERIMG=lICENSENUMBERIMG;
	}

	public String getLICENSENUMBERIMG(){
		return lICENSENUMBERIMG;
	}

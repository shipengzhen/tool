...
<section class="bg_write">
	<div class="edit_code_tips">手机号验证成功请重新设置密码</div>
	<input type="hidden" id="telNum" value="${telNum}"/>
	<ul class="edit_form">
		<li><input type="password" id="password"  placeholder="请输入6-20位新密码，必须数字与字母组合"></li>

...
<section class="bg_write">
	<div class="edit_code_tips">原支付密码验证成功请重新设置支付密码</div>
	<ul class="edit_form">
		...
		<li><input type="text" id="kb2" class="default" placeholder="再次入6位数字支付密码" onfocus="removeGray();" />
			<script>
	...
	<div id="submit" class="btn_warp">
		<a href="javascript:resetPayPassword();">保存</a>
	</div>
</section>
